...
const DecoCalc = {
    ...
    {
        let mod = DiveCalc.mod(mix.o2, mppO2, env.salt, env.sp).intVal();
        let res = {
        ...
        while (!apox) {
            let ead  = mix.ead(depth, env.salt);
...
class DiveSiteEnv
{
    ...
    {
        this.sp   = sp;
        // If SP < .99 isn't sea level... So, just can fresh water!
        this.salt = this.sp < .99 ? false : conf.dc.salt;
        Object.freeze(this);
    }
}
