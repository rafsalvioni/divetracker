...
class DesatState
{
    ...
    save(dive)
    {
        ...
        this.#last = {
            ...
            noDive: 0,
            noFly:  DAYMIN * (this.#last ? .75 : .5) // Single dives: 12hrs - Multiple dives / days: 18hrs
        }
...
export const desatState = new DesatState();
