...
class DecoState
{
    ...
    save(dive)
    {
        ...
        this.#dive.desat = DecoCalc.desat(this.#dive.group);
...
export class Dive extends EventTarget
{
    ...
    get decoGroup()
    {
        let ead = this.#ead();
        let dur = this.durMin;
        return DecoCalc.decoGroup(ead, dur, this.#resGroup);
    }
    ...
    #ndl()
    {
        return DecoCalc.ndl(this.#ead(), this.#resGroup);
    }
}
...
class DecoStops
{
    ...
    update(dive)
    {
        ...
        if (dive.maxDepth >= 30 || DecoCalc.safetyStop(dive.avgDepth, dive.decoGroup)) { // Safety stop
