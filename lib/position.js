...
import { AccelDistanceCounter, Peak3DistanceCounter, PeakYDistanceCounter } from './dist.js';
import './proto.js';
...
const IMU_ACCUR_FACTOR = Math.abs(1 - conf.imu.accuracy);
