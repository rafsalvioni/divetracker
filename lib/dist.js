...
/**
 * Auxiliar class to collect data from Distance Counters
 * 
 */
class Collector
{
    /**
     * @type {DistanceCounter}
     */
    #source;
    /**
     * @type {object}
...
class DistanceCounter extends EventTarget
{
    ...
    /**
     * Rotates displacement using orientation and dispatch a event
     * 
    ...
    _notifyDist(s, ori)
    {
        ...
        Coords.rotateByEuler(ori, s2, 'yxz');
        //console.log(s2);
     ...
     * Starts counter
     * 
     * @type {boolean} analyze Use analizer?
     */
    start(analyze = false)
    {
        if (analyze) {
...
class PeakYDistanceCounter extends DistanceCounter
{
    ...
    __counter(e)
    {
        ...
        this._notifyDist(s, ori); // Rotate movement to Earth's frame
...
class AccelDistanceCounter extends DistanceCounter
{
    ...
    calcConf()
    {
        ...
        return {
            threshold: Math.rounds(data.max, 2)
        };
    }
...
/**
 * Loads default Distance Counter
 * 
 * @returns {DistanceCounter}
 */
