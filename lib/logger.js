...
class DiveLogger extends DataLogger
{
    ...
    {
        return {
            time: dive.durSec, depth: Math.rounds(dive.depth, 2)
        };
    }
    ...
    #logEvent(e)
    {
        ...
        switch (e.type) {
            ...
            case 'end':
                log = {
                    type:       e.type,
                    maxDepth:   Math.rounds(e.target.depth.max, 2),
                    avgDepth:   Math.rounds(e.target.depth.avg, 2),
            ...
            case 'event':
                switch (e.detail) {
                    case 'gaschange':
                        detail = {mix: Object.enumGetters(e.target.curMix)};
                        break;
                    default:
                        return;
                }
    ...
    startDive(dive)
    {
        ...
        let xml = {
            ...
            informationbeforedive: {
                ...
                surfacepressure: ((dive.sp ?? 1.013) * 100000).intVal(),
