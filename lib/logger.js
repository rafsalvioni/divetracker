...
\t<generator><name>DiveTracker</name><datetime>"+(new Date()).toISOLocalString()+"</datetime></generator>\n\
\t<divesite>\n\
\t</divesite>\n\
\t<gasdefinitions>\n\
\t</gasdefinitions>\n\
\t<profiledata>\n";
    ...
    startDive(dive, pos = null)
    {
        ...
        this.#curDive = id;
        this.#xml += `<datetime>${dive.startDate.toISOLocalString()}</datetime>\
</informationbeforedive>\n\t\t\t\t<samples>\n`;
    }
...
<name>${siteId}</name>\
<geography><latitude>${site.lat}</latitude><longitude>${site.lon}</longitude><altitude>${site.alt}</altitude><timezone>${site.tz}</timezone></geography>\
