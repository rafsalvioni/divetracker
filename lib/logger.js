...
class DiveLogger extends DataLogger
{
    ...
    #sample(dive)
    {
        for (let alert of dive.alerts) {
            ...
            this.#event.alert.pushUnique(alert);
        }
        return {
...
class UddfWriter
{
    ...
    startDive(dive)
    {
        ...
        if (desat) {
            ...
            xml.informationbeforedive.surfaceintervalbeforedive.passedtime = dive.si * 60;
        }
        if (dive.site) {
        ...
        if (this.#curDive > 0) {
            ...
            if (this.#endInfo) {
                dive.informationafterdive = {
                    ...
                    noflighttime:  this.#endInfo.si.noFly * 60 
                };
                this.#endInfo = null;
            }
            this.#curDive *= -1;
